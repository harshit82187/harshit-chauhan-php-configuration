******************************* Admin Card, Pie Chart And Graph Chart Dyanmic Show **********************************************
...
<style>
    /* Scoped styles only for the Pie Chart */
    .pie-chart-container {
        width: 100%;
        margin: auto;
        background: white;
                    ...
                    <div class="row">
                            ...
                            <div class="card l-bg-green-dark hover">
                                <a style="font-weight:bold;color:white;text-decoration:none;"
                                    ...
                                    <div class="card-statistic-3">
                                        ...
                                        <div class="card-content">
                                            <h4 class="card-title">Total Vendor</h4>
                                            <div class="d-flex justify-content-between">
                                                <span><b>{{ $vendor ?? '0' }} </b><b></b></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div class="col-6">
                            <div class="card l-bg-cyan-dark hover">
                                <a style="font-weight:bold;color:white;text-decoration:none;"
                                    href="{{ url('admin/weekend/deal') }}">
                                    <div class="card-statistic-3">
                                        <div class="card-icon card-icon-large"><i class="fa fa-briefcase"></i></div>
                                        <div class="card-content">
                                            <h4 class="card-title">Weekend Property</h4>
                                            <div class="d-flex justify-content-between">
                                                <span><b>{{ $propertyWeekendDeal ?? '0' }} </b><b></b></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div class="col-6">
                            <div class="card l-bg-orange-dark hover">
                                <a style="font-weight:bold;color:white;text-decoration:none;"
                                    href="{{ url('admin/ticket/list') }}">
                                    <div class="card-statistic-3">
                                        <div class="card-icon card-icon-large"><i class="fa fa-money-bill-alt"></i></div>
                                        <div class="card-content">
                                            <h4 class="card-title">Help & Ticket</h4>
                                            <div class="d-flex justify-content-between">
                        ...
                        <div class="col-6">
                            <div class="card l-bg-purple-dark hover">
                                <a style="font-weight:bold;color:white;text-decoration:none;" href="{{ url('admin/blogs/add') }}">
                                    <div class="card-statistic-3">
                                        <div class="card-icon card-icon-large"><i class="fa fa-globe"></i></div>
                                        <div class="card-content">
                                            <h4 class="card-title">Total Blog</h4>
                                            <div class="d-flex justify-content-between">
                                                <span><b>{{ $blog ?? '0' }} </b><b></b></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="card l-bg-green-dark hover">
                                <a style="font-weight:bold;color:white;text-decoration:none;"
                                    ...
                                    <div class="card-statistic-3">
                                        <div class="card-icon card-icon-large"><i class="fa fa-award"></i></div>
                                        <div class="card-content">
                                            <h4 class="card-title">Total Query</h4>
                                            <div class="d-flex justify-content-between">
                                                <span><b>{{ $contactUsSubmission ?? '0' }} </b><b></b></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div class="col-6">
                            <div class="card l-bg-cyan-dark hover">
                                <a style="font-weight:bold;color:white;text-decoration:none;"
                                    href="{{ url('admin/show-comment') }}">
                                    <div class="card-statistic-3">
                                        <div class="card-icon card-icon-large"><i class="fa fa-briefcase"></i></div>
                                        <div class="card-content">
                                            <h4 class="card-title">Total Comments On Hotels</h4>
                                            <div class="d-flex justify-content-between">
                                                <span><b>{{ $comment ?? '0' }} </b><b></b></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                ...
                <div class="col-5">
                    <div class="row justify-content-center">
                        <div class="report-container mt-0 mb-2">
                            <label class="report-label">Report Table</label>
                            <form id="filter-form" action="{{ route('admin.data.filter') }}" method="post">
                                @csrf
            ...
            <div class="row">
                <div class="col-7">
                    <div class="line-chart-container">
                        <div>
                            <h2>Users, Vendors & Bookings Trend</h2>
...
@push('js')
            ...
            function fetchTableData(data) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('.spinner').hide();
                        let tableBody = '';
                        tableBody += '<tr><td>Users On Board</td><td>' + response.data.user_count +
                            '</td></tr>';
                        tableBody += '<tr><td>Vendors On Board</td><td>' + response.data.vendor_count +
                            '</td></tr>';
                        tableBody += '<tr><td>Property Listed</td><td>' + response.data.property_count +
                            '</td></tr>';
                        tableBody += '<tr><td>Bookings</td><td>' + response.data.booking_count +
                            '</td></tr>';
                        tableBody += '<tr><td>Ticket On Board</td><td>' + response.data.ticket_count +
                            '</td></tr>';
    ...
    <script>
        const userCount = @json($user);
        const vendorCount = @json($vendor);
        const ticketCount = @json($ticket);
        const pieData = {
            labels: ["User", "Vendor", "Ticket"],
            datasets: [{
                label: "On Board",
                data: [userCount, vendorCount, ticketCount], 
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const monthlyUsers = @json($monthlyData['users']);
            const monthlyVendors = @json($monthlyData['vendors']);
            const monthlyBookings = @json($monthlyData['bookings']);
...
public function dashboard(){
    ...
    $vendor = Vendor::where('status','1')->count();
    $user = User::where('status','1')->count();
    $ticket = Ticket::where('status','1')->count();
    $propertyWeekendDeal = PropertyWeekendDeal::count();
    $blog = Blogs::count();
    $contactUsSubmission = ContactUsSubmission::count();
    $comment = Comment::count();

    $monthlyData = [];
    for ($month = 1; $month <= 12; $month++) {
        $monthlyData['users'][] = User::where('status', '1')
            ->whereMonth('created_at', $month)
            ->whereYear('created_at', date('Y'))
            ->count();

        $monthlyData['vendors'][] = Vendor::where('status', '1')
            ->whereMonth('created_at', $month)
            ->whereYear('created_at', date('Y'))
            ->count();

        $monthlyData['bookings'][] = Booking::whereMonth('created_at', $month)
            ->whereYear('created_at', date('Y'))
            ->count();
    }
    return view('backend.dashboard',compact('vendor','propertyWeekendDeal','user','ticket','blog','contactUsSubmission','comment','monthlyData'));
}
...
public function dataFilter(Request $req) {
    ...
    $property_count = Property::where('status', '1')           
        ->whereBetween('created_at', [$startDate, $endDate])
        ->count();

    $booking_count = Booking::whereBetween('created_at', [$startDate, $endDate])->count();

    $ticket_count = Ticket::where('status','1')           
        ->whereBetween('created_at', [$startDate, $endDate])
        ->count();
